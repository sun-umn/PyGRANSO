...
def makeStructWithFields(varargin):
    ...
    makeStructWithFields
        ...
        Change Log:
            makeStructWithFields.m introduced in GRANSO Version 1.5.
            
            Buyun Dec 20, 2021 (NCVX Version 1.0.0):
                makeStructWithFields.py is translated from makeStructWithFields.m in GRANSO Version 1.6.4. 
