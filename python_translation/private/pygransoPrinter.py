...
from private import pygransoConstants as pC, gransoPrinterColumns as gPC, tablePrinter as tP, printMessageBox as pMB
...
class pgP:
    ...
    def pygransoPrinter(self,opts,n,n_ineq,n_eq):
        ...
        cols        = gPC.pygransoPrinterColumns(print_opts,self.n_ineq, self.n_eq)
        ...
        setattr(printer, "msg", )
        setattr(printer, "close", )
        setattr(printer, "msgWidth", )
        setattr(printer, "init", )
        setattr(printer, "iter", )
        setattr(printer, "summary", )
        setattr(printer, "unscaledMsg", )
        setattr(printer, "lineSearchRestart", )
        setattr(printer, "bfgsInfo", )
        setattr(printer, "regularizeError", )
        setattr(printer, "qpError", )
        setattr(printer, "quadprogFailureRate", )
        ...
        def init(self,penfn_at_x,stat_value,n_qps):
            ...
            self.table_printer.row(  self.iter_c.format_fn(0),                        ...
                                pen_values{:},                              ...
        ...
        def iteration( self,iter, penfn_at_x,sd_code,random_attempts,ls_evals,alpha,n_grads,stat_value,n_qps):
            ...
            self.table_printer.row(  self.iter_c.format_fn(iter),                     ...
                                pen_values{:},                              ...
                                self.obj_c.format_fn(penfn_at_x.f),              ...
                                viol_values{:},                             ...
                                info_values{:},                             ...
        ...
        def summary(self,name,penfn_at_x):   
            ...
            self.table_printer.row(  self.iter_c.format_str(name),                    ...
                                self.mu_c.blank_str,                             ...
