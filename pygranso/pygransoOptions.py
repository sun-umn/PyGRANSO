...
def getDefaults(n):
    ...
    setattr(default_opts, "prescaling_threshold", np.inf)
    ...
    setattr(default_opts, "maxclocktime", np.inf)
    setattr(default_opts, "fvalquit", -np.inf)
    ...
    setattr(default_opts, "regularize_threshold", np.inf)
