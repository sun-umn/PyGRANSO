function [f,f_grad] = objectiveFunction(w,x)
%   objectiveFunction: (examples/ex2)
...
% 
%   USAGE:
%       [f,f_grad] = objectiveFunction(w,x);
% 
%   INPUT:
...
%
%   examples/ex2/objectiveFunction.m introduced in GRANSO Version 1.5.
%
% =========================================================================
